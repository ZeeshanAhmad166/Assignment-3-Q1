...
cubeArea(40);
let tempConvertor = (temp_In_Fahrenheit, temp_In_Celsius) => {
...
let sec_to_min = (number_In_Seconds) => {
...
sec_to_min(350);
let percentage = (obtained_Marks, total_Marks) => {
...
let check_eligibility = (user_age, nationality) => {
    if (user_age >= 18) {
